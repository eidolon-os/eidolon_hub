...
| Kernel owner namespace | Architecture + Workspace Integration | real Hub approval/get/revoke + Kernel adapter/store/reconcile | Admission/Mount 单一权威、reader 最小权限、跨 Owner fail closed、revocation→tombstone |
