...
class DeviceRow(Base):
    ...
    identity_key_fingerprint: Mapped[str] = mapped_column(String(80), default="")
    pairing_method: Mapped[str] = mapped_column(String(64), default="")
    pairing_secret_hash: Mapped[str] = mapped_column(String(71), default="")
