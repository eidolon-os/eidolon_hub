...
class SqlDeviceRepository:
    ...
    def _values(device: ManagedDevice) -> dict[str, object]:
        return {
            ...
            "identity_key_fingerprint": device.identity_key_fingerprint,
            "pairing_method": device.pairing_method,
            "pairing_secret_hash": device.pairing_secret_hash,
    ...
    def _decode(row: DeviceRow) -> ManagedDevice:
        return ManagedDevice(
            ...
            pairing_secret_hash=row.pairing_secret_hash,
